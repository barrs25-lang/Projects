...
car.MCAR = Mcar + 1*Mmale + 1*Mfem;   % total mass of car
...
car.Tdead = 100;            % deadzone torque (Nm)
...
%  Note:  Do NOT uncomment these four lines for run_VC_bench sim
% east0 = 0;    % initial easting coordinate (meters)
% north0 = 0;   % initial northing coordinate (meters)
% psi0 = 0*2*pi*rand(1);    % initial heading (radians)
